...
It's a command that is safe to use at any time. If you wan tto see what is going on in it's good to us `git status` in between commands until you get to know the flow better.
